...
from leem.model import transformer
from leem.trainer import trainer as trainer_lib


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Run the training routine.")
    p.add_argument("--model_name", type=str, default="line-corporation/line-distilbert-base-japanese")
    p.add_argument(
        "--model_save_path",
        type=str,
        default=None,
...
def main() -> None:
    ...
    model = transformer.TransformerBasedEncoder(
